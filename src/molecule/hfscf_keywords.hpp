...
namespace Keywords
{
    inline std::multimap<std::string, std::string> lookup_keyword
    {
        ...
        {"freq_write_molden", "true"}, {"freq_write_molden", "false"},
    ...
    inline std::map<std::string, std::string_view> err_mesg =
    {
        ...
        {"freq_write_molden", " expecting \"freq_write_molden = true|false\""},
    ...
    std::map<std::string, std::function<void(const T )> > set_setting
    {
        ...
        {"freq_write_molden", &hf_settings::set_freq_write_molden},
